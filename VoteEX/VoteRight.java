   ...
   public void init() throws ServletException {
	...
	public static JSONObject contract_deploy(String host,String account,String passwd, String contract_address, String voter) throws IOException {
		...
		if(voter.equals("AllUser"))
                	pb.command("python3", "/home/yenkuanlee/TEST/Ethereum-Contract-Web3/VoteEX/GiveRightToVoters.py",host,account,passwd,contract_address,voter);
		else
			pb.command("python3", "/home/yenkuanlee/TEST/Ethereum-Contract-Web3/VoteEX/GiveRightToVoters.py",host,account,passwd,contract_address);
