...
$(document).ready(function () {
    ...
    fetch('http://140.92.143.82:8888/GetVoter', {
        method: 'GET'
    }).then(function (res) {
        return res.json()
    }).then(function (res) {
        ...
        let reqAry = $('.e_vote_count').map((idx, elm) => {
            ...
            if (count > 0) {
                ...
                return new Promise((rev, rej) => {
                    fetch('http://140.92.143.82:8888/Vote?host=' + sessionStorage.getItem('userHost') + '&account=' + sessionStorage.getItem('user') + '&passwd=' + sessionStorage.getItem('psw') + '&contract_address=' + ca + '&to_Voter=' + voter + '&cnt=' + count, {
                        method: 'GET'
                    }).then(function (res) {
                        return res.json()
                    }).then(function (res) {
    ...
    $('#newVote_btn').unbind().bind('click', e => {
        ...
        $('#voteModal').modal('hide')
        $('body').loading()
        fetch(encodeURI('http://140.92.143.82:8888/VoteContractDeploy?host=' + sessionStorage.getItem('userHost') + '&account=' + sessionStorage.getItem('user') + '&passwd=' + sessionStorage.getItem('psw') + '&topic=' + topic + '&Pnum=' + Pnum + '&prop=' + prop.join(',,,') + '&deadline=' + deadline), {
            method: 'GET'
        }).then(function (res) {
            return res.json()
        }).then(function (res) {
...
function getVoteAPI() {
    fetch('http://140.92.143.82:8888/GetVote', {
            method: 'GET'
        })
        .then(function (res) {
            return res.json()
...
function setVoteRight(add) {
    if ($('#checkall').is(':checked')) {
        fetch(encodeURI('http://140.92.143.82:8888/VoteRight?host=' + sessionStorage.getItem('userHost') + '&account=' + sessionStorage.getItem('user') + '&passwd=' + sessionStorage.getItem('psw') + '&contract_address=' + add + '&voter=AllUser'), {
            method: 'GET'
        }).then(function (res) {
            return res.json()
        }).then(function (res) {
        ...
        var pary = voteRightAry.map(elm => {
            return new Promise((rev, rej) => {
                fetch(encodeURI('http://140.92.143.82:8888/VoteRight?host=' + sessionStorage.getItem('userHost') + '&account=' + sessionStorage.getItem('user') + '&passwd=' + sessionStorage.getItem('psw') + '&contract_address=' + add + '&voter=' + elm), {
                    method: 'GET'
                }).then(function (res) {
                    return res.json()
                }).then(function (res) {
...
function dosignin(data) {
    ...
    let pa = $('.fakeForm').map((idx, elm) => {
        ...
        return new Promise((rev, rej) => {
            fetch('http://140.92.143.82:8888/CheckVoteContract?host=' + data.host + '&contract_address=' + ca + '&behavior=GetRemainVoteWeight&arg=' + data.user, {
                method: 'GET'
            }).then(function (res) {
                return res.json()
            }).then(function (res) {
...
function addQuestion(ser) {
    fetch('http://140.92.143.82:8888/ContractDeploy?' + ser, {
            method: 'GET'
        })
        .then(function (res) {
            return res.json()
...
function ansQuestion(ser) {
    fetch('http://140.92.143.82:8888/AnswerQuestion?' + ser, {
            method: 'GET'
        })
        .then(function (res) {
            return res.json()
...
function checkList(ser) {
    fetch('http://140.92.143.82:8888/CheckContract?' + ser + '&behavior=checkList', {
            method: 'GET'
        })
        .then(function (res) {
            return res.json()
...
function checkAnswer(ser) {
    fetch('http://140.92.143.82:8888/CheckContract?' + ser + '&behavior=checkAnswer', {
            method: 'GET'
        })
        .then(function (res) {
            return res.json()
